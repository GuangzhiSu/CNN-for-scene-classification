...
#         return True
#     else:
#         print(f"No saved weights found at {weight_path}. Training will proceed.")
#         return False


# def main(train_mode=True, num_epochs=10):
#     # Create the model
#     model = SceneRecognitionModel(num_classes=20)
#     model = model.to(device)
#     # Check if saved weights exist and decide to load or train
#     if not train_mode or load_model_weights(model, save_dir):
#         print("Skipping training, proceeding with evaluation...")
#     else:
...
if __name__ == "__main__":
    # train_mode = True  # Set to True if you want to train, False to load pre-trained weights

    # # Run the main function
    # main(train_mode=train_mode, num_epochs=10)
